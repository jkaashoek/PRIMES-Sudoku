...
We first present an overview of our general framework to synthesize
puzzles of varying complexity levels. Our framework takes three
...
question~\cite{sudokuchaos}. In our framework, we try to approximate
...
Our framework allows for any $\isremovevalid$ function such as a
